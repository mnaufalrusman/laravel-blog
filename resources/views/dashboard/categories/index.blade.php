        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <a href="/dashboard/categories/create" class="btn btn-primary mb-3 ml-3 mt-3">Create new categories</a>
                    <table class="table table-striped table-md">
                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td>{{ $category->name }}</td>
                                <td><a href="/dashboard/categories/{{ $category->slug }}" class="btn btn-info"><i
